        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {designs.length === 0 ? (
            <div className="col-span-full text-center py-20 bg-white/10 backdrop-blur-lg rounded-3xl">
              <h2 className="text-3xl font-semibold text-white mb-4">No Design Projects Available</h2>
              <p className="text-white/80 text-lg">Check back soon for exciting new designs!</p>
            </div>
          ) : (

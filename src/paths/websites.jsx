        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {websites.length === 0 ? (
            <div className="col-span-full text-center py-10 sm:py-20 bg-white/10 backdrop-blur-lg rounded-3xl">
              <h2 className="text-2xl sm:text-3xl font-semibold text-white mb-4">No Web Projects Available</h2>
              <p className="text-white/80 text-base sm:text-lg">Check back soon for exciting new web projects!</p>
            </div>
          ) : (
